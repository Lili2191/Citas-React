    ...
    return(
        <div className="bg-slate-300 shadow-md px-5 mx-5 rounded-md">
            ...
            <div className="flex justify-between mt-10">
                <button type="button"className="bg-indigo-600 hoverbg-indigo-700 text-white px-10 uppercase rounded-lg"
                onClick={()=>setPaciente(paciente)}>Editar</button>
                <button type="button"className="bg-red-600 hoverbg-red-700 text-white px-10 uppercase rounded-lg"
